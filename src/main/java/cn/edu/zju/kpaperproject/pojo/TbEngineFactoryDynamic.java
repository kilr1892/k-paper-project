...
public class TbEngineFactoryDynamic {
    ...
    private Double engineFactoryCreditH;
    ...
    public Double getEngineFactoryCreditH() {
        return engineFactoryCreditH;
    }

    public void setEngineFactoryCreditH(Double engineFactoryCreditH) {
        this.engineFactoryCreditH = engineFactoryCreditH;
    }
